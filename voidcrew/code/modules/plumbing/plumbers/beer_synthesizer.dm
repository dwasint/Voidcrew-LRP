...
/obj/machinery/plumbing/beer_synthesizer
...
/obj/machinery/plumbing/beer_synthesizer/Initialize(mapload, bolt)
	. = ..()
	AddComponent(/datum/component/plumbing/simple_supply, bolt)

/obj/machinery/plumbing/beer_synthesizer/process()
...
/obj/machinery/plumbing/beer_synthesizer/ui_interact(mob/user, datum/tgui/ui)
	ui = SStgui.try_update_ui(user, src, ui)
	if(!ui)
		ui = new(user, src, "ChemSynthesizer", name)
		ui.open()

/obj/machinery/plumbing/beer_synthesizer/ui_data(mob/user)
	var/list/data = list()
...
/obj/machinery/plumbing/beer_synthesizer/ui_act(action, params)
	. = ..()
	if(.)
		return
	. = TRUE
...
/obj/machinery/plumbing/beer_synthesizer/update_overlays()
	. = ..()
